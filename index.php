...
<body>
  ...
  <div class="container">
      ...
      <p class="p1">A career with The Wright Cut features a one-of-a-kind environment with guaranteed clientele, great pay & incentives, as well as opportunities for career advancement.</p>
      <p class="p1">We're interviewing for full-time & part-time licensed barbers & stylists, receptionist, and hair washers/shampooist. We're looking for individuals that are motivated, positive, reliable, upbeat, and career-oriented, that have a current license and passion for doing men's and boys' haircuts with a client first attitude. </p>
      <p class="p1">Tell us a little about yourself. Enter or select a response for each question below.</p>
